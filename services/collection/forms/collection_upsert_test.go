...
import (
	...
	"github.com/pafthang/servicebase/services/collection/forms"
...
func TestNewCollectionUpsert(t *testing.T) {
	...
	collection.Schema = collectionmodels.NewSchema(&collectionmodels.SchemaField{
		Name: "test",
	...
	collection.Schema.AddField(&collectionmodels.SchemaField{
		Name: "new_field",
...
func TestCollectionUpsertValidateAndSubmit(t *testing.T) {
	...
	scenarios := []struct {
		...
		},
		{
			...
			`{
				...
				"options": {
					"query": "select id, email from users; drop table teams;"
				},
	...
	for _, s := range scenarios {
		t.Run(s.testName, func(t *testing.T) {
			...
			interceptorCalls := 0
			interceptor := func(next baseforms.InterceptorNextFunc[*collectionmodels.Collection]) baseforms.InterceptorNextFunc[*collectionmodels.Collection] {
				return func(c *collectionmodels.Collection) error {
					interceptorCalls++
					return next(c)
				}
			}
...
func TestCollectionUpsertSubmitInterceptors(t *testing.T) {
	...
	interceptor1 := func(next baseforms.InterceptorNextFunc[*collectionmodels.Collection]) baseforms.InterceptorNextFunc[*collectionmodels.Collection] {
		return func(c *collectionmodels.Collection) error {
	...
	interceptor2 := func(next baseforms.InterceptorNextFunc[*collectionmodels.Collection]) baseforms.InterceptorNextFunc[*collectionmodels.Collection] {
		return func(c *collectionmodels.Collection) error {
...
func TestCollectionUpsertWithCustomId(t *testing.T) {
	...
	newCollection := func() *collectionmodels.Collection {
