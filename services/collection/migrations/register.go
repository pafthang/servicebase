...
// the collection module to own its migration pack.
...
// Register wires collection migrations into the shared app migration list.
func Register(register RegisterFunc) {
	register1640988000CollectionInit(register)
}
