...
func TestNewSchemaAndFields(t *testing.T) {
	testSchema := collectionmodels.NewSchema(
		&collectionmodels.SchemaField{Id: "id1", Name: "test1"},
		&collectionmodels.SchemaField{Name: "test2"},
		&models.SchemaField{Id: "id1", Name: "test1_new"}, // should replace the original id1 field
	)
...
func TestSchemaInitFieldsOptions(t *testing.T) {
	f0 := &models.SchemaField{Name: "test1", Type: "unknown"}
	schema0 := models.NewSchema(f0)
	...
	f1 := &models.SchemaField{Name: "test1", Type: models.FieldTypeText}
	f2 := &models.SchemaField{Name: "test2", Type: models.FieldTypeEmail}
	schema1 := models.NewSchema(f1, f2)
	...
	if _, ok := f1.Options.(*models.TextOptions); !ok {
		t.Fatalf("Failed to init f1 options")
	}

	if _, ok := f2.Options.(*models.EmailOptions); !ok {
...
func TestSchemaAsMap(t *testing.T) {
	f1 := &models.SchemaField{Name: "test1", Type: models.FieldTypeText}
	f2 := &models.SchemaField{Name: "test2", Type: models.FieldTypeEmail}
	testSchema := models.NewSchema(f1, f2)
...
func TestSchemaGetFieldByName(t *testing.T) {
	f1 := &models.SchemaField{Name: "test1", Type: models.FieldTypeText}
	f2 := &models.SchemaField{Name: "test2", Type: models.FieldTypeText}
	testSchema := models.NewSchema(f1, f2)
...
func TestSchemaGetFieldById(t *testing.T) {
	f1 := &models.SchemaField{Id: "id1", Name: "test1", Type: models.FieldTypeText}
	f2 := &models.SchemaField{Id: "id2", Name: "test2", Type: models.FieldTypeText}
	testSchema := models.NewSchema(f1, f2)
...
func TestSchemaRemoveField(t *testing.T) {
	f1 := &models.SchemaField{Id: "id1", Name: "test1", Type: models.FieldTypeText}
	f2 := &models.SchemaField{Id: "id2", Name: "test2", Type: models.FieldTypeText}
	f3 := &models.SchemaField{Id: "id3", Name: "test3", Type: models.FieldTypeText}
	testSchema := models.NewSchema(f1, f2, f3)
...
func TestSchemaAddField(t *testing.T) {
	f1 := &models.SchemaField{Name: "test1", Type: models.FieldTypeText}
	f2 := &models.SchemaField{Id: "f2Id", Name: "test2", Type: models.FieldTypeText}
	f3 := &models.SchemaField{Id: "f3Id", Name: "test3", Type: models.FieldTypeText}
	testSchema := models.NewSchema(f1, f2, f3)

	f2New := &models.SchemaField{Id: "f2Id", Name: "test2_new", Type: models.FieldTypeEmail}
	f4 := &models.SchemaField{Name: "test4", Type: models.FieldTypeUrl}
	...
	if f := testSchema.GetFieldById("f2Id"); f == nil || f.Type != models.FieldTypeEmail {
...
func TestSchemaValidate(t *testing.T) {
	...
	duplicatedIdsSchema := models.NewSchema(
		&models.SchemaField{Id: "id1", Name: "test1", Type: models.FieldTypeText},
		&models.SchemaField{Id: "id2", Name: "test2", Type: models.FieldTypeText},
	)
	...
	scenarios := []struct {
		...
		{
			models.NewSchema(
				&models.SchemaField{Name: "test", Type: models.FieldTypeText},
				&models.SchemaField{Name: "TeSt", Type: models.FieldTypeText},
			),
			true,
		},
		...
		{
			models.NewSchema(
				&models.SchemaField{Name: "", Type: models.FieldTypeText},
			),
			true,
		},
		...
		{
			models.NewSchema(
				&models.SchemaField{Name: "test", Type: models.FieldTypeFile},
			),
			true,
		},
		...
		{
			models.NewSchema(
				&models.SchemaField{Name: "test", Type: models.FieldTypeFile, Options: &models.FileOptions{MaxSelect: 1, MaxSize: 1}},
			),
			false,
		},
	}
...
func TestSchemaMarshalJSON(t *testing.T) {
	f1 := &models.SchemaField{Id: "f1id", Name: "test1", Type: models.FieldTypeText}
	f2 := &models.SchemaField{
		Id:      "f2id",
		Name:    "test2",
		Type:    models.FieldTypeText,
		Options: &models.TextOptions{Pattern: "test"},
	}
	testSchema := models.NewSchema(f1, f2)
...
func TestSchemaUnmarshalJSON(t *testing.T) {
	...
	testSchema := models.Schema{}
	testSchema.AddField(&models.SchemaField{Name: "tempField", Type: models.FieldTypeUrl})
	...
	_, ok := f1.Options.(*models.TextOptions)
	if !ok {
	...
	o2, ok := f2.Options.(*models.TextOptions)
	if !ok {
