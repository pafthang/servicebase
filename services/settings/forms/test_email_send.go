...
func (form *TestEmailSend) Submit() error {
	...
	// create a test users record
	collection := &collectionmodels.Collection{
		BaseModel: basemodels.BaseModel{Id: "__pb_test_collection_id__"},
	...
	record.Set(collectionmodels.FieldNameUsername, "pb_test")
	record.Set(collectionmodels.FieldNameEmail, form.Email)
