...
import (
	...
	"github.com/pafthang/servicebase/services/settings/forms"
...
func TestSettingsUpsertValidateAndSubmit(t *testing.T) {
	...
	for i, s := range scenarios {
		...
		interceptorCalls := 0
		interceptor := func(next baseforms.InterceptorNextFunc[*settingsmodels.Settings]) baseforms.InterceptorNextFunc[*settingsmodels.Settings] {
...
func TestSettingsUpsertSubmitInterceptors(t *testing.T) {
	...
	interceptor1 := func(next baseforms.InterceptorNextFunc[*settingsmodels.Settings]) baseforms.InterceptorNextFunc[*settingsmodels.Settings] {
		return func(s *settingsmodels.Settings) error {
	...
	interceptor2 := func(next baseforms.InterceptorNextFunc[*settingsmodels.Settings]) baseforms.InterceptorNextFunc[*settingsmodels.Settings] {
		return func(s *settingsmodels.Settings) error {
