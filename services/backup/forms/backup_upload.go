...
func (form *BackupUpload) Submit(interceptors ...forms.InterceptorFunc[*filesystem.File]) error {
	if err := form.Validate(); err != nil {
		return err
	}

	return forms.RunInterceptors(form.File, func(file *filesystem.File) error {
		fsys, err := form.app.NewBackupsFilesystem()
		if err != nil {
			return err
		}
