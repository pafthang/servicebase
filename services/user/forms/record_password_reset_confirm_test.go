...
func TestRecordPasswordResetConfirmValidateAndSubmit(t *testing.T) {
	...
	for i, s := range scenarios {
		form := userforms.NewRecordPasswordResetConfirm(testApp, authCollection)
		...
		interceptorCalls := 0
		interceptor := func(next baseforms.InterceptorNextFunc[*models.Record]) baseforms.InterceptorNextFunc[*models.Record] {
