...
var _ Model = (*LoggingProject)(nil)
var _ Model = (*AppLog)(nil)
...
func (m *AppLog) TableName() string {
	return "logs"
}

func (m *AppLog) SetContextMap(ctx map[string]interface{}) error {
	if ctx == nil {
...
func (m *AppLog) GetContextMap() (map[string]interface{}, error) {
	if len(m.Context) == 0 {
