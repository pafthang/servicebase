...
func TestFindCollectionsByType(t *testing.T) {
	...
	scenarios := []struct {
		...
		{"", false, 0},
		{"unknown", false, 0},
		{collectionmodels.CollectionTypeUsers, false, 3},
		{collectionmodels.CollectionTypeBase, false, 7},
	}
...
func TestDeleteCollection(t *testing.T) {
	...
	colUnsaved := &collectionmodels.Collection{}
...
func TestSaveCollectionCreate(t *testing.T) {
	...
	collection := &collectionmodels.Collection{
		Name: "new_test",
		Type: collectionmodels.CollectionTypeBase,
...
func TestSaveCollectionIndirectViewsUpdate(t *testing.T) {
	...
	// update MaxSelect fields
	{
		...
		relManyOpt := relMany.Options.(*collectionmodels.RelationOptions)
		relManyOpt.MaxSelect = types.Pointer(1)

		fileOne := collection.Schema.GetFieldByName("file_one")
		fileOneOpt := fileOne.Options.(*collectionmodels.FileOptions)
...
func TestSaveCollectionViewWrapping(t *testing.T) {
	...
	for _, s := range scenarios {
		t.Run(s.name, func(t *testing.T) {
			...
			collection := &collectionmodels.Collection{
				Name: viewName,
				Type: collectionmodels.CollectionTypeView,
...
func TestImportCollections(t *testing.T) {
	...
	scenarios := []struct {
		...
		jsonData               string
		deleteMissing          bool
		beforeRecordsSync      func(txDao *daos.Dao, mappedImported, mappedExisting map[string]*collectionmodels.Collection) error
		expectError            bool
		expectCollectionsCount int
		beforeTestFunc         func(testApp *tests.TestApp, resultCollections []*collectionmodels.Collection)
		afterTestFunc          func(testApp *tests.TestApp, resultCollections []*collectionmodels.Collection)
	}{
		{
