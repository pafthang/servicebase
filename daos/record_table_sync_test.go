...
func TestSyncRecordTableSchema(t *testing.T) {
	...
	scenarios := []struct {
		...
		},
		{
			...
			&models.Collection{
				Name: "new_table_auth",
				Type: models.CollectionTypeUsers,
				Schema: models.NewSchema(
					&models.SchemaField{
						Name: "test",
						Type: models.FieldTypeText,
...
func TestSingleVsMultipleValuesNormalization(t *testing.T) {
	...
	}
	{
		...
		collection.Schema.AddField(&models.SchemaField{
			Name: "new_multiple",
